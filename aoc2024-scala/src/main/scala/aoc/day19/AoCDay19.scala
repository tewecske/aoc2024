...
###############"""
  ...
  println(day19part1(parse(lines2)))
  // println(day19part1(parse(lines))) // 1471926
  // println(day19part2(parse(lines2)))
  // println(day19part2(parse(lines))) // 
  val endTime = System.currentTimeMillis()
  println(s"Solved in: ${endTime - start} ms")
}
// part 2 hint: https://github.com/scarf005/aoc-scala/blob/main/2024/day19.scala
def day19part1(grid: Grid[Char]): Long = {
